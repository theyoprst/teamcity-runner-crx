...
/** @private */
AutoSuggestControl.prototype.initTextbox_ = function() {
  var thisRef = this;
...
/** @private */
AutoSuggestControl.prototype.createDropDown_ = function() {
 ...
 */
AutoSuggestControl.prototype.setSuggestions_ = function(suggestions) {
 ...
 * @param {Array.<string>} suggestions
 */
AutoSuggestControl.prototype.showSuggestions_ = function(suggestions) {
  this.selectedIndex_ = -1;
 ...
 */
AutoSuggestControl.prototype.hideSuggestions_ = function() {
 ...
 */
AutoSuggestControl.prototype.getTextboxLeft_ = function() {
 ...
 */
AutoSuggestControl.prototype.getTextboxTop_ = function() {
  var node = this.textbox_;
  var top = 0;
  while (node.tagName != 'BODY') {
    top += node.offsetTop;
 ...
 * @param {Event} event
 */
AutoSuggestControl.prototype.handleKeyUp_ = function(event) {
  var thisRef = this;
 ...
 * @param {Event} event
 */
AutoSuggestControl.prototype.handleKeyDown_ = function(event) {
  var KEY_RETURN = 13;
  var KEY_UP = 38;
  var KEY_DOWN = 40;
 ...
 */
AutoSuggestControl.prototype.isModifyingKey_ = function(keyCode) {
  var KEY_DELETE = 46;
  var KEY_BACKSPACE = 8;
  var KEY_SPACE = 32;
  var KEY_F1 = 112;
 ...
 */
AutoSuggestControl.prototype.highlightSuggestion_ = function(suggestionNode) {
...
/** @private */
AutoSuggestControl.prototype.nextSuggestion_ = function() {
...
/** @private */
AutoSuggestControl.prototype.previousSuggestion_ = function() {
  var suggestionNodes = this.dropdownLayer_.childNodes;
